...
minúsculas. Este método se invocará al crear el objeto y no será visible.13
...
Se debe crear también una subclase llamada Teresolución (en pulgadas) y sintonizador TDT (booleano), además de los atributos
heredados.levisor con los siguientes atributos:
