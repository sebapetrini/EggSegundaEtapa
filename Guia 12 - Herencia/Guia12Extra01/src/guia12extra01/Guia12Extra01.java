...
public class Guia12Extra01
{
    ...
    {
        alquilerServicios s = new alquilerServicios();
        Alquiler a = s.crearAlquiler();
        System.out.println(a);

        System.out.println("-----------------------------------------");

        System.out.println("Cantidad de dias: " + s.calcularDias(a));

        System.out.println("------------------------------------------");

        System.out.println("Valor alquiler: " + s.calcularAlquiler(a));
